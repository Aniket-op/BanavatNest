    ...
    const FOCUS_AREAS: FocusAreaItem[] = [
        {
            ...
            title: t('rdTitle'),
            items: [
                { heading: t('rd.items.0.heading'), desc: t('rd.items.0.desc') },
                { heading: t('rd.items.1.heading'), desc: t('rd.items.1.desc') },
                { heading: t('rd.items.2.heading'), desc: t('rd.items.2.desc') },
                { heading: t('rd.items.3.heading'), desc: t('rd.items.3.desc') },
                { heading: t('rd.items.4.heading'), desc: t('rd.items.4.desc') },
            ],
        ...
        },
        {
            ...
            title: t('protoTitle'),
            items: [
                { heading: t('proto.items.0.heading'), desc: t('proto.items.0.desc') },
                { heading: t('proto.items.1.heading'), desc: t('proto.items.1.desc') },
                { heading: t('proto.items.2.heading'), desc: t('proto.items.2.desc') },
                { heading: t('proto.items.3.heading'), desc: t('proto.items.3.desc') },
                { heading: t('proto.items.4.heading'), desc: t('proto.items.4.desc') },
            ],
        ...
        },
        {
            ...
            title: t('acadTitle'),
            items: [
                { heading: t('acad.items.0.heading'), desc: t('acad.items.0.desc') },
                { heading: t('acad.items.1.heading'), desc: t('acad.items.1.desc') },
                { heading: t('acad.items.2.heading'), desc: t('acad.items.2.desc') },
                { heading: t('acad.items.3.heading'), desc: t('acad.items.3.desc') },
                { heading: t('acad.items.4.heading'), desc: t('acad.items.4.desc') },
            ],
        ...
        },
        {
            ...
            title: t('techTitle'),
            items: [
                { heading: t('tech.items.0.heading'), desc: t('tech.items.0.desc') },
                { heading: t('tech.items.1.heading'), desc: t('tech.items.1.desc') },
                { heading: t('tech.items.2.heading'), desc: t('tech.items.2.desc') },
                { heading: t('tech.items.3.heading'), desc: t('tech.items.3.desc') },
                { heading: t('tech.items.4.heading'), desc: t('tech.items.4.desc') },
            ],

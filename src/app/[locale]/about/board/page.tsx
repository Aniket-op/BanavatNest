                        ...
                        >
                            <div className="flex flex-col md:flex-row items-center md:items-center gap-8 mb-10 text-center md:text-left">
                                ...
                                <div className="flex-grow">
                                    ...
                                    <p className="text-[#3A9B9B] font-bold text-lg md:text-xl uppercase tracking-widest leading-tight">{t('sukhdevRole')}</p>
                                </div>
                            </div>
                        ...
                        >
                            <div className="flex flex-col md:flex-row items-center md:items-center gap-8 mb-10 text-center md:text-left">
                                ...
                                <div className="flex-grow">
                                    ...
                                    <p className="text-[#3A9B9B] font-bold text-lg md:text-xl uppercase tracking-widest leading-tight">{t('sangitaRole')}</p>
                                </div>
                            </div>
                            <p className="text-zinc-600 dark:text-zinc-400 text-lg leading-relaxed mb-6 font-medium">
                                {t('sangitaBio')}
